...
<style type="text/css">#hellopreloader>p{display:none;}#hellopreloader_preload{display: block;position: fixed;z-index: 99999;top: 0;left: 0;width: 100%;height: 100%;min-width: 1000px;background: #34495E url(http://hello-site.ru//main/images/preloads/bars.svg) center center no-repeat;background-size:160px;}</style>
...
<header>
  <div class="menu">
    <nav>  
      ...
      <ul>
        <li style="float: left; font-size: 25px;padding: 6px; margin-left: 20px; position: relative;border: 1px solid white; margin-top: -14px;"><span><a style="border: none;" href="">MUINLIM</a></span></li>
...
<div class="left">
  <div>
    ...
    <img width="50%" src="img/left_1.jpg"><br>
  ...
  <div>
    ...
    <img width="50%" src="img/left_2.jpg"><br>
    <p>Knowledge nay estimable questions repulsive daughters boy. Solicitude gay way unaffected expression for. His mistress ladyship required off horrible disposed rejoiced. Unpleasing pianoforte unreserved as oh he unpleasant no inquietude insipidity.
    </p><br>
  ...
  <div class="scrool">
    <a href="#">&laquo;</a>
    <a href="file:///C:/OpenServer/domains/forzz1/index.php">1</a>
