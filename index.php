...
<header>
  <div class="menu">
    <nav>  
      ...
      <input type="checkbox" name="menu" id="btn-menu" /><br>
      <li id="logo_text" class="logo"><span><a style="border: none;" href="#">MUINLIUM</a></span></li>
